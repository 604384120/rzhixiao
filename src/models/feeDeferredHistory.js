...
export default modelExtend(pageModel, {
  namespace: 'feeDeferredHistory',

  state: {

    sortSence: 'feeDeferredHistorySort',
    displaySence: 'feeDeferredHistoryDisplay',
    userSortExtra: {
      accountId: '经办人',
    },
    ...
    dataList: [],
    feeDeferredSum: null,
    feeDeferredCount: null,
  },

  subscriptions: {
    setup ({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === '/feeDeferredHistory') {
  ...
  effects: {
    * query ({ payload = {} }, { call, put, select }) {
      const { userSortExtra, sortSence, displaySence } = yield select(_ => _.feeDeferredHistory)
      yield put({
    ...
    * getFeeDeferredHistory ({ payload }, { put, call }) {
      ...
      yield put({
        ...
        payload: {
          ...
          feeDeferredSum: data.ret_content.updateFeeSum,
          feeDeferredCount: data.ret_content.count,
